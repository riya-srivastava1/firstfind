            ...
            <div class="col-xl-12">
                ...
                <div class="panel panel-inverse" data-sortable-id="form-validation-1">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" action="{{ route('banner.update',$banner->id ??'') }}" data-parsley-validate="true"
                                ...
                                <div id="tracking_id" class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <input class="form-control" type="text" id="tracking_id" name="name"
                                            value="{{ old('name',$banner->name ??'') }}"  placeholder="Enter banner name"
                            >
                                        @if ($errors->has('name'))
                                ...
                                <div id="priority" class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <select name="priority" id="modeoftransport" class="form-select mb-1">
                                            ...
                                            <option value="high" {{ old('priority', $banner->priority ?? '') == 'high' ? 'selected' : '' }}>High</option>
                                            <option value="medium" {{ old('priority', $banner->priority ?? '') == 'medium' ? 'selected' : '' }}>Medium</option>
                                            <option value="normal" {{ old('priority', $banner->priority ?? '') == 'normal' ? 'selected' : '' }}>Normal</option>
                                        </select>
