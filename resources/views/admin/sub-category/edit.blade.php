...
@section('content')
    <div id="content" class="app-content">
        ...
        <ol class="breadcrumb justify-content-end">
            ...
            <li class="breadcrumb-item"><a href="{{ route('subcategory.index') }}">subcategory Listing</a></li>
            ...
            <div class="col-xl-12">
                ...
                <div class="panel panel-inverse" data-sortable-id="form-validation-1">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" action="{{ route('subcategory.update',$subcategory->id ??'') }}" data-parsley-validate="true"
                            method="POST" id="subcategoryForm" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div id="tracking_id" class="col-md-4">
                                    <div class="form-group mb-3">
                                        <label class="col-form-label form-label">SubCategory Name
                                ...
                                <div id="tracking_id" class="col-md-4">
                                    <div class="form-group mb-3">
                                        <label class="col-form-label form-label">subCategory name <span class="text-danger"
                                ...
                                <div id="priority" class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <select name="priority" id="modeoftransport" class="form-select mb-1">
                                            ...
                                            <option value="high" {{ old('priority', $subcategory->priority ?? '') == 'high' ? 'selected' : '' }}>High</option>
                                            <option value="medium" {{ old('priority', $subcategory->priority ?? '') == 'medium' ? 'selected' : '' }}>Medium</option>
                                            <option value="normal" {{ old('priority', $subcategory->priority ?? '') == 'normal' ? 'selected' : '' }}>Normal</option>
                                        </select>
                                        ...
                                        <div class="d-flex justify-content-start align-items-center">
                                            <div class="form-check me-3">
                                                <input type="radio" class="form-check-input" name="is_featured" id="is_featured_yes" value="1"
                                                    {{ $subcategory->is_featured == 1 ? 'checked' : '' }}>
                                            ...
                                            <div class="form-check">
                                                <input type="radio" class="form-check-input" name="is_featured" id="is_featured_no" value="0"
                                                    {{ $subcategory->is_featured == 0 ? 'checked' : '' }}>
