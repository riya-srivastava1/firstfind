...
@section('content')
    <div id="content" class="app-content">
        ...
        <ol class="breadcrumb justify-content-end">
            ...
            <li class="breadcrumb-item"><a href="{{ route('subcategory.index') }}">Sub category Listing</a></li>
            ...
            <div class="col-xl-12">
                ...
                <div class="panel panel-inverse" data-sortable-id="form-validation-1">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" action="{{ route('subcategory.store') }}" data-parsley-validate="true"
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="d-flex justify-content-start align-items-center">
                                            ...
                                            <div class="form-check me-3">
                                                <input type="radio" class="form-check-input" name="is_featured"
                                                    id="is_featured_yes" value="1">
                                                <label class="form-check-label" for="is_featured_yes">Yes</label>
                                            </div>
                                            <!-- No Option -->
                                            <div class="form-check">
                                                <input type="radio" class="form-check-input" name="is_featured"
                                                    id="is_featured_no" value="0">
